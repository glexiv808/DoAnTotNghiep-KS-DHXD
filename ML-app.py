...
# ====================================================
# NEW: Database + Auth setup (SQLite)
# ====================================================
...
# Tạo FastAPI app
app = FastAPI(title="ML Prediction Service", version="0.1.0", lifespan=lifespan)

# NEW: Allow CORS for UI (adjust origins in production)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
